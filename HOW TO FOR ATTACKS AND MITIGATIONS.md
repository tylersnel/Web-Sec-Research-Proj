...
- **Attacks:**
    ...
    - Test 4: Head to the admin page from the login page. The username and password are both admin. An alert should appear warning of an XSS attack due to the username `<script>alert("XSS attack")</script>`
